    ...
    return (
        <div className={`bg-${darkMode}`}>
            ...
            <div className='container mx-auto px-12 max-sm:px-2 flex justify-center h-[10vh]'>
                <div className="relative w-1/2 flex items-start py-6 max-sm:py-2 max-xl:w-full flex justify-center max-md:flex-col max-md:items-center gap-4">
